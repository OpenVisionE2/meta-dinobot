...
SRCDATE = "20180502"
SRCDATE_axashis4kcomboplus = "20180828"
SRCDATE_dinobot4kplus = "20180828"
...
SRC_URI[axashis4kcomboplus.md5sum] = "f0dd43d5adc013d0dd89061e3249855a"
SRC_URI[axashis4kcomboplus.sha256sum] = "32a8caabfba94d81b649de8dd62cc5b02e1d750cad8d2676e98e242a944273a3"

SRC_URI[dinobot4kplus.md5sum] = "f0dd43d5adc013d0dd89061e3249855a"
SRC_URI[dinobot4kplus.sha256sum] = "32a8caabfba94d81b649de8dd62cc5b02e1d750cad8d2676e98e242a944273a3"
...
SRC_URI_axashis4kcomboplus = "http://source.mynonpublic.com/dinobot/dinobot-linux-${PV}-${SRCDATE}.tar.gz;name=${MACHINE} \
    file://defconfig \
...
SRC_URI_dinobot4kplus = "http://source.mynonpublic.com/dinobot/dinobot-linux-${PV}-${SRCDATE}.tar.gz;name=${MACHINE} \
    file://defconfig \
    file://0002-log2-give-up-on-gcc-constant-optimizations.patch \
    file://0003-uaccess-dont-mark-register-as-const.patch \
    file://0004-makefile-disable-warnings.patch \
